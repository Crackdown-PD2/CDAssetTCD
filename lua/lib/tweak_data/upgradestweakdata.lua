...
Hooks:PostHook(UpgradesTweakData, "init", "tcd_upgradestd_init", function(self, tweak_data)
...
Hooks:PostHook(UpgradesTweakData,"_init_pd2_values","tcd_upgradestd_btnmacros",function(self)
