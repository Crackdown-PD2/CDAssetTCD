Hooks:PostHook(BlackMarketTweakData, "_init_projectiles", "tcd_projectiletd_init", function(self, tweak_data)
	self.projectiles.tripmine_throwable = {
		...
		local_unit = "units/equipment/tripmine_throwable/tripmine_throwable_local",
