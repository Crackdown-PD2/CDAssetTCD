...
Hooks:OverrideFunction(CivilianBrain,"on_hostage_move_interaction",function(self, interacting_unit, command)
	...
	if command == "move" then
		...
		local max_nr = interacting_unit:base():upgrade_value("player","max_civ_hostage_followers",tweak_data.player.max_nr_following_hostages) -- the only changes are here
		if following_hostages and max_nr <= table.size(following_hostages) then -- and here
			return
		end
